...
public class TranslateAPI {
    ...
    private String makeURL() throws UnsupportedEncodingException {
        String url = "https://script.google.com/macros/s/AKfycbz_XszfZNwwc3GsvDOXe8nPrT9dZ4MyZCy5ujcly6Ighr8rmTyMOD0jsYjRUTSllz4WMw/exec" +
                    "?q=" + URLEncoder.encode(sourceWord, "UTF-8") +
                    "&target=" + targetLang +
                    "&source=" + sourceLang;
        return url;
    }
